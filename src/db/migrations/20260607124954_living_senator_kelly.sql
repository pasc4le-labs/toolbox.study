...
CREATE TABLE `__new_ai_providers` (
	...
	`created_at` integer DEFAULT 1780836594598 NOT NULL
);
...
--> statement-breakpoint
INSERT INTO `__new_bundles`("id", "title", "description", "emoji", "cover_color", "exam_question_count", "exam_time_limit_seconds", "exam_difficulty_filter", "exam_points_per_correct", "exam_points_per_wrong", "created_at") SELECT "id", "title", "description", "emoji", "cover_color", "exam_question_count", "exam_time_limit_seconds", "exam_difficulty_filter", "exam_points_per_correct", "exam_points_per_wrong", "created_at" FROM `bundles`;--> statement-breakpoint
...
CREATE TABLE `__new_card_fsrs` (
	...
	`due` integer DEFAULT 1780836594598 NOT NULL,
...
CREATE TABLE `__new_cards` (
	...
	`created_at` integer DEFAULT 1780836594598 NOT NULL,
	`updated_at` integer DEFAULT 1780836594598 NOT NULL
);
--> statement-breakpoint
