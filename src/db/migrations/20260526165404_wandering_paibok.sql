...
CREATE TABLE `__new_ai_providers` (
	...
	`created_at` integer DEFAULT 1779814444567 NOT NULL
);
...
--> statement-breakpoint
INSERT INTO `__new_bundles`("id", "title", "description", "created_at") SELECT "id", "title", "description", "created_at" FROM `bundles`;--> statement-breakpoint
...
CREATE TABLE `__new_card_fsrs` (
	...
	`due` integer DEFAULT 1779814444567 NOT NULL,
...
CREATE TABLE `__new_cards` (
	...
	`created_at` integer DEFAULT 1779814444567 NOT NULL,
	`updated_at` integer DEFAULT 1779814444567 NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_exams`("id", "title", "bundle_id", "question_count", "time_limit_seconds", "difficulty_filter", "created_at") SELECT "id", "title", "bundle_id", "question_count", "time_limit_seconds", "difficulty_filter", "created_at" FROM `exams`;--> statement-breakpoint
...
CREATE TABLE `__new_todos` (
	...
	`created_at` integer DEFAULT 1779814444568 NOT NULL
);
--> statement-breakpoint
