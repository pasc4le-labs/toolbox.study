...
CREATE TABLE `__new_ai_providers` (
	...
	`created_at` integer DEFAULT 1780781438263 NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_bundles` (
	...
	`created_at` integer DEFAULT 1780781438262 NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_card_fsrs` (
	...
	`due` integer DEFAULT 1780781438263 NOT NULL,
...
CREATE TABLE `__new_cards` (
	...
	`created_at` integer DEFAULT 1780781438262 NOT NULL,
	`updated_at` integer DEFAULT 1780781438262 NOT NULL
);
--> statement-breakpoint
